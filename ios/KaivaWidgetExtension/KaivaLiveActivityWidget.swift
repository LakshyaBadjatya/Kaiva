...
private enum KaivaPalette {
    static let background   = Color(red: 0x13/255, green: 0x13/255, blue: 0x13/255) // #131313
    static let primary      = Color(red: 0xFF/255, green: 0xBF/255, blue: 0x6F/255) // #ffbf6f
    static let primaryDeep  = Color(red: 0xEF/255, green: 0x9F/255, blue: 0x27/255) // #ef9f27
    static let onSurfaceVar = Color(red: 0xD7/255, green: 0xC3/255, blue: 0xAE/255) // #d7c3ae
    ...
    var body: some View {
        VStack(spacing: 12) {
            HStack(spacing: 14) {
                ...
                Spacer()
                EqualizerBars(isPlaying: state.isPlaying, barCount: 5, maxHeight: 22)
            }
            ...
            HStack(spacing: 10) {
                ...
                Text(formatRemaining(state.elapsedSeconds, state.durationSeconds))
                    .font(.system(size: 10, weight: .medium))
                    .foregroundColor(.white.opacity(0.5))
